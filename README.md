# ExApp 
ExApp is a solution based on R and shiny package to visualise biodiversity data stored in a database structure called exabase: https://github.com/r-poloni/exabase. This database structure is built upon Darwin Core standard and accomodates both individual based records and occurrence based records. 
